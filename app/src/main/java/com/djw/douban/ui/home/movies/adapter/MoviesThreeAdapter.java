...
public class MoviesThreeAdapter extends RecyclerView.Adapter<MoviesThreeAdapter.MoviesHolder> {

    private Context context;

    private List<MoviesThreee> list;

    public MoviesThreeAdapter(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
    }

    public void notifyDataChange(List<MoviesThreee> list, boolean isLoadMore) {
    ...
    public void onBindViewHolder(MoviesHolder holder, int position) {
        final MoviesThreee moviesOnee = list.get(position);
