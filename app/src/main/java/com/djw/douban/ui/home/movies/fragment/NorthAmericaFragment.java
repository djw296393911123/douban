 ...
 */
public class NorthAmericaFragment extends BaseFragment<NorthAmericaPresenter> implements NorthAmericaContract.View, XRecyclerView.LoadingListener {
    ...
    protected void initView(View view) {
        ...
        adapter = new NorthAmericaRecyclerAdapter(getActivity());
    ...
    @Override
    public void showMoviesList(List<NorthAmericaItemData.SubjectsBean> subjectsBeen, boolean isLoadMore) {
