...
class NewMovieNineAdapter extends RecyclerView.Adapter<NewMovieNineAdapter.NewMovieNineHolder> {

    private List<NewMovieNineItemData> list;

    private Context context;

    NewMovieNineAdapter(Context context) {
    ...
    public NewMovieNineHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new NewMovieNineHolder(LayoutInflater.from(context).inflate(R.layout.item_new_nine_item, parent, false));
    }
