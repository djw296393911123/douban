 ...
 */
public class HotFragment extends BaseFragment<HotPresenter> implements MoviesContract.View, XRecyclerView.LoadingListener {
    ...
    public void showProgress() {
        if (isFirst) ((MainActivity) getActivity()).showProgress();
        isFirst = false;
    }
