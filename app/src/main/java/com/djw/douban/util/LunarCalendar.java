...
public class LunarCalendar {
    ...
    private String CalConv2(int yy, int mm, int dd, int y, int d, int m, int dt) {
        ...
        if ((yy == 0 && dd == 6) || (yy == 6 && dd == 0) || (yy == 1 && dd == 7) ||
            ...
            return "日值月破 大事不宜";
        } else if ((y == 0 && Objects.equals(dy, "911")) || (y == 1 && Objects.equals(dy, "55")) || (y == 2 && Objects.equals(dy, "111")) ||
                (y == 3 && Objects.equals(dy, "75")) || (y == 4 && Objects.equals(dy, "311")) || (y == 5 && Objects.equals(dy, "95")) ||
                (y == 6 && Objects.equals(dy, "511")) || (y == 7 && Objects.equals(dy, "15")) || (y == 8 && Objects.equals(dy, "711")) || (y == 9 && dy == "35")) {
            return "日值上朔 大事不宜";
    ...
    public List<ThingsBaseData> getyiji(int year, int month) {
        ...
        for (int i = 0; i < days_of_month; i++) {
            ...
            yiji.add(new ThingsData(mLDay + "号", str));
        }
     ...
     * 公历某日宜忌
     * */
    public String getJinji(int year, int month, int day) {
        int num_y = -1;
        int num_m = (year - 1900) * 12 + month - 1 + 12;
        int num_d;
