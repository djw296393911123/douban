...
/**
 * Created by JasonDong on 2017/4/27.
 */
...
//            ((LoadingMoreFooter) mFootView).setNoMoreHint(noMore);
     ...
     * @param gridManager
     */
    private void setSpanSizeLookup(final GridLayoutManager gridManager, final MyXRecyclerView.WrapAdapter mWrapAdapter) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    MyXRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    MyXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
